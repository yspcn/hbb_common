...
pub const LINK_DOCS_X11_REQUIRED: &str = "https://rustdesk.com/docs/zh-cn/client/linux/#x11-required";
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["8.148.7.103"];
pub const RS_PUB_KEY: &str = "XRwDjEcpXImYLg4I3uLYyg7bochMFcQ6FYOJ9BCueH4=";
