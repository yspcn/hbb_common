...
pub const LINK_DOCS_HOME: &str = "https://rustdesk.com/docs/zh-cn/";
pub const LINK_DOCS_X11_REQUIRED: &str = "https://rustdesk.com/docs/zh-cn/client/mac/";
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rd.aijinju.com"];
pub const RS_PUB_KEY: &str = "BbrD4OL6p7Ctz3dbtMtW+2ejV8WoGnWckjNzDI+v730=";
